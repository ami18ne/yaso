...
import { useConversations, useMessages, useSendMessage, useGetOrCreateConversation } from "@/hooks/useMessages";
...
import { Plus, Search as SearchIcon, MessageCircle, ArrowLeft, Edit, Camera, Circle, Phone, Video, Settings, MoreVertical, Trash2, VolumeX, Pin } from "lucide-react";
  ...
  const handleStartConversation = async (userId: string) => {
    try {
      ...
      toast({
        ...
        description: error?.message || "Failed to start a conversation with this user. Please try again.",
        variant: "destructive",
      });
    }
  };
          ...
          <div className="py-1">
            {(!conversations || conversations.length === 0) ? (
              <div className="flex flex-col items-center justify-center py-12 px-6">
                ...
                <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                  <DialogTrigger asChild>
                    <Button className="gradient-primary rounded-full px-6">
                      Start Chat
                    </Button>
                  </DialogTrigger>
                  <NewConversationDialog
          ...
          <>
            <div className="flex items-center gap-3 px-4 py-3 border-b border-border/40 bg-background">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-semibold truncate">{selectedConversationData?.username || "Chat"}</p>
