...
export default function CommunitiesPage() {
  ...
  const { data: discoverCommunities = [], isLoading: isLoadingDiscover } = useDiscoverCommunities('', 1, 6);
  ...
  return (
    <div className="container mx-auto p-4 sm:p-6">
      <header className="flex flex-col sm:flex-row justify-between sm:items-center mb-8">
        <h1 className="text-3xl font-bold tracking-tight text-foreground mb-4 sm:mb-0">Communities</h1>
        ...
        <section className="mb-12">
          ...
          {isLoadingUserCommunities ? (
            ...
            <div className="text-center border-2 border-dashed border-border rounded-lg py-12">
                ...
                <p className="text-sm text-muted-foreground">Find a community below or create your own!</p>
            </div>
          )}
        </section>
      )}
      ...
      <section>
        <div className="flex justify-between items-center mb-4">
            ...
            {/* The DiscoverCommunities modal could be triggered from here */}
        </div>
        {isLoadingDiscover ? (
            <div className="text-center text-muted-foreground py-8">Loading...</div>
