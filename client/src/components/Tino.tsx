        ...
        {open && (
          ...
          >
            <div className="flex items-start gap-3">
              <div className="h-10 w-10 rounded-full bg-[rgb(255,107,0)] flex items-center justify-center text-black font-bold">T</div>
              <div className="flex-1">
                ...
                <div className="mt-3">
                  <div className="h-10 bg-[rgba(255,255,255,0.02)] rounded px-3 flex items-center">
                    <input className="bg-transparent w-full outline-none text-sm" placeholder="Ask Tino..." onFocus={() => setTyping(true)} onBlur={() => setTyping(false)} />
                    <div className="ml-2">
                      <button className="px-2 py-1 rounded bg-[rgb(255,107,0)] text-black text-sm">Send</button>
                    </div>
                  </div>
                  <div className="mt-2">
                    <div className={"h-3 w-16 rounded-full bg-[rgba(255,107,0,0.4)] animate-pulse-slow " + (typing ? 'opacity-100' : 'opacity-50')} />
                  </div>
                </div>
              </div>
            </div>
