...
import { AtSign, Check, Heart, Mail, MessageCircle, Phone, UserPlus, Video } from 'lucide-react'
      ...
      <div className="p-4 md:p-6 border-b border-border/50">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            {unreadCount > 0 && (
              <Badge
                className="gradient-primary text-white border-0 px-2.5 py-0.5"
          ...
          {notifications.map((notification, index) => (
            ...
            >
              ...
              <div className="flex items-start gap-2 flex-shrink-0">
                ...
                {!notification.isRead && <div className="h-2 w-2 rounded-full bg-primary mt-3" />}
              </div>
            </button>
          ))}
        </div>
