        ...
        <div className="mt-4">
          <Link href="/search">
            <div className={`relative group ${isRTL ? 'direction-rtl' : 'direction-ltr'}`}>
              <Search
                className={`absolute h-4 w-4 text-muted-foreground transition-colors group-focus-within:text-primary ${isRTL ? 'right-3' : 'left-3'} top-1/2 -translate-y-1/2`}
              />
              <Input
                ...
                >
                  <div
                    className={cn(
                      ...
                      isActive ? 'text-[rgb(255,107,0)]' : 'text-foreground'
                    )}
                  >
                  ...
                  {!collapsed && (
                    <span
                      className={cn(
                        'text-sm',
                        isActive ? 'text-[rgb(255,107,0)]' : 'text-foreground/90'
                      )}
                    >
                      <span className="group-hover:text-[#FF4500] group-hover:font-bold transition-all group-hover:drop-shadow-[0_0_5px_#FF4500]">
                        {label.slice(0, 1)}
                      </span>
                  ...
                  {isActive && !collapsed && (
                    <div className="absolute left-0 top-1/2 -translate-y-1/2 h-8 w-1 rounded-r bg-[rgb(255,107,0)]" />
                  )}
                </Button>
              </Link>
            )
