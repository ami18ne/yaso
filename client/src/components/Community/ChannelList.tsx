  ...
  return (
    <div className="w-60 bg-[#24272B] h-full flex flex-col p-2">
      ...
      <div className="flex-1 overflow-y-auto pr-1">
        {/* Text Channels */}
        <ChannelCategory title="Text Channels" channels={textChannels} selectedChannel={selectedChannel} onSelectChannel={onSelectChannel} />

        {/* Voice Channels */}
        <div className="mt-4">
            <ChannelCategory title="Voice Channels" channels={voiceChannels} selectedChannel={selectedChannel} onSelectChannel={onSelectChannel} />
        </div>
      </div>
...
const ChannelLink = ({ channel, isSelected, onClick }: any) => {
    ...
    return (
        <button
            ...
            `}
        >
            <Icon size={16} className={`mr-2 ${isActive ? 'text-neutral-200' : 'text-neutral-500 group-hover:text-neutral-400'}`} />
