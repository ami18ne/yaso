...
const MemberList = () => {
  return <div className="w-60 bg-[#24272B] p-2">
      <h2 className="text-xs font-semibold text-neutral-400 uppercase tracking-wide px-2 mb-2">Members - 0</h2>
  </div>;
};
...
export default function CommunityPage() {
  ...
  if (!communityId) {
    return <div className="flex h-screen w-full items-center justify-center bg-[#313439] text-white">Community not found.</div>;
  }
