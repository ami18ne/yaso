      ...
      <DialogContent className="max-w-4xl h-[80vh] flex p-0 gap-0">
        ...
        <div className="w-2/3 p-6 overflow-y-auto rounded-r-lg">
          ...
          <div className="mt-4">
            ...
            {selectedCategory === 'Roles & Permissions' && <div>Roles & Permissions Settings Content</div>}
            {selectedCategory === 'Member Management' && <div>Member Management Settings Content</div>}
